...
export default function RadioButtonsGroup() {
  ...
  return (
    <div className="page" style={{ backgroundImage: "url('https://images.pexels.com/photos/6207817/pexels-photo-6207817.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')" ,backgroundSize: "cover"}}>
