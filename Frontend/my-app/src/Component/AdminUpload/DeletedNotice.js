...
handleSubmit = (e) => {
  ...
  if (Object.keys(errors).length === 0) {
      console.log(data);
      //Call an api here
      axios.post('https://lankafurnituremakersapi.azurewebsites.net/api/DeletedDesigns/',{input_Design_Code:this.state.data.input_Design_Code, statusof_Design:this.state.data.statusof_Design, deleted_Reason:this.state.data.deleted_Reason })
