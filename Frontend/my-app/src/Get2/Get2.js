...
componentDidMount() {
    axios.get(`https://projectbackendlankafurnituremakers.azurewebsites.net/api/Customers`).then(res => { console.log("new",res);
    ...
    getUser= (e) => {
        ...
        if(word){
            ...
            axios.get(`https://projectbackendlankafurnituremakers.azurewebsites.net/api/Customers/${word}`)
