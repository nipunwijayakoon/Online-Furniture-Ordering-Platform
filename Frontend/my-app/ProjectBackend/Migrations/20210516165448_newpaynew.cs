...
{
    public partial class newpaynew : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BillingNewId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Design_Code = table.Column<string>(nullable: true),
                    CardName = table.Column<string>(nullable: true),
                    CardNo = table.Column<string>(nullable: true),
                    ExpMonth = table.Column<int>(nullable: false),
                    ExpYear = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ConfirmedNewDesigns",
                columns: table => new
                {
                    ConfirmedID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Input_Design_Code = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Statusof_Order = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Estimated_Amount = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Transportation_Amount = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Total_Amount = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Advance_Fee = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConfirmedNewDesigns", x => x.ConfirmedID);
                });
            ...
            migrationBuilder.CreateTable(
                name: "DeletedNewDesigns",
                columns: table => new
                {
                    DeletedID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Input_Design_Code = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Statusof_Design = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    Deleted_Reason = table.Column<string>(type: "nvarchar(50)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeletedNewDesigns", x => x.DeletedID);
                });
